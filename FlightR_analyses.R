...
Proc.data<-get.tags.data("A2_FLightR_twl.csv") #opens and formats data straight from TAGS formatted csv file
load("FLightR_calibration") #loads object called Calibration
