...
## unrealistic positions around the equinox
    ...
    fall_eq_start <- fall_eq - (window/2)*24*60*60 # note: POSIXct dates are in seconds
...
## Furthermore, GeoLight allows you to simplify the movement path to stationary sites only.
